//program to demonstrate search of single linked list with functions call by reference
//b171325
//Harsha
...
void insert_at_pos(int,int,struct node **);
void insert_at_mid(int,struct node **);
void delete_ele(int,struct node **);
void delete_pos(int,int,struct node **);
...
void insert_at_pos(int x,int c,struct node ** head){
	int i=1;
	if(x==1){
...
void insert_at_mid(int x,struct node **head){
	int i=1;
		struct node* new_node;
		struct node* prev;
		new_node=(struct node*)malloc(sizeof(struct node));
...
void delete_ele(int x,struct node ** head){
...
void delete_pos(int x,int c,struct node ** head){
	struct node* act_node = *head;
	struct node* prev_node = *head;
	struct node* temp=*head;
